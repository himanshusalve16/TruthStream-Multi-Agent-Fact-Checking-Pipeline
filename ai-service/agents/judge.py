    ...
    for attempt in range(MAX_RETRIES + 1):
        try:
            ...
            if attempt < MAX_RETRIES:
                ...
                return _compute_fallback_verdict(claims, sources_by_claim, bias_result)
...
def _compute_fallback_verdict(
    ...
    """
    Pure-Python fallback verdict computation when LLM is unavailable.
    Uses weighted source stance scoring as described in blueprint section 11.2.
    """
    claim_verdicts = []
